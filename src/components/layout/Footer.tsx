...
export default function Footer() {
  return (
    <footer className="bg-dark-green" aria-labelledby="footer-heading">
            ...
            <div className="flex items-center space-x-2">
              {navigation.social.map((item) => (
                <a 
                  ...
                  className="text-gray-400 hover:text-gray-300 transition-colors duration-200 p-2 rounded-lg hover:bg-gray-800/30 flex items-center justify-center"
                >
