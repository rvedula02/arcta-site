...
const features = [
  ...
  {
    name: 'Expert Transcript Assessment',
  ...
  {
    name: 'Search Across Virtual Data Rooms',
  ...
  {
    name: 'Financial Benchmarking and Q of E',
  ...
  {
    name: 'Industry Research and Trend Analysis',
    description: 'Enterprise-grade security for your sensitive financial data and operations.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  {
    name: 'Portfolio Monitoring and Sentiment Analysis',
    description: 'Enterprise-grade security for your sensitive financial data and operations.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
...
export default function Home() {
  return (
    <div className="text-gray-300 bg-gray-950 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature) => (
              <div key={feature.name} className="flex flex-col rounded-lg p-6 bg-transparent hover:bg-gray-900/50 transition-colors border border-gray-700 hover:border-gray-600">
                ...
                <dt className="font-semibold text-gray-100 text-lg mb-2">
                  {feature.name}
                </dt>
      ...
      {/* CTA section - Added top border */}
      <div className="relative isolate mt-32 px-6 py-32 sm:mt-40 sm:py-40 lg:px-8 border-t border-gray-700 pt-16">
